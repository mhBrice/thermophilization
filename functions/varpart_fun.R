...
varpart_plot <- function(vp, labels = c('Baseline', "Climate change", "Disturbances"), pval, col_frac) {
  ...
  # Draw circles
  plotrix::draw.circle(0, 3, 5.5, col = col_frac[1])
  plotrix::draw.circle(-3, -3, 5.5, col = col_frac[2])
  plotrix::draw.circle(3, -3, 5.5, col = col_frac[3])

  plotrix::draw.circle(0, 3, 5.5)
  plotrix::draw.circle(-3, -3, 5.5)
